<template>
  <div>
    ...
    -->
    <div v-if="dataOrdo.length !== 0" class="max-h-72 overflow-auto drop-shadow-md my-5 rounded-lg bg-white">
    ...
    <div v-else class="p-10 drop-shadow-md my-5 rounded-lg bg-white">
      <h1 class="font-bold text-ord-green-100 text-3xl text-center">
