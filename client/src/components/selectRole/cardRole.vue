  ...
  <div class="m-5">
    <router-link to="/" class="group flex place-content-center px-10 py-6 bg-white rounded-2xl shadow-md w-64 h-64">
      <div class="flex flex-col place-content-center">
        ...
        <svg v-if="role === 'patient'" class="mx-auto group-hover:fill-ord-green-100 h-40" fill="#2D3047"
             xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 448 512">
          <path
              d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z"/>
        </svg>
        <p v-if="role === 'patient'" class="mt-4 text-2xl font-black text-ord-dark-blue group-hover:text-ord-green-100">Patient</p>

        <svg v-if="role === 'doctor'" class="mx-auto group-hover:fill-ord-green-100 h-40" fill="#2D3047"
             xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 448 512">
          <path
        ...
        <p v-if="role === 'doctor'" class="mt-4 text-2xl font-black text-ord-dark-blue group-hover:text-ord-green-100">Medecin</p>

        <svg v-if="role === 'pharma'" class="mx-auto group-hover:fill-ord-green-100 h-40" fill="#2D3047" width="150px" height="150px"
             xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 576 512">
          <path
        ...
        <p v-if="role === 'pharma'" class="mt-4 text-2xl font-black text-ord-dark-blue group-hover:text-ord-green-100">Pharmacie</p>

        <svg v-if="role === 'healthService'" class="mx-auto group-hover:fill-ord-green-100 h-40" fill="#2D3047" width="150px" height="150px"
             xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 640 512">
          <path
        ...
        <p v-if="role === 'healthService'" class="mt-4 text-2xl font-black text-ord-dark-blue group-hover:text-ord-green-100">Service de santé</p>
